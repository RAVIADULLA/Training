...
- Name of the Server            :       ssadcloudmainsqlserver
...
- Container                     :        processed/output-from-azsqldb
...
- Sink Dataset Name                         :       `ds_sink_adls_emp2`

# Pipeline Overview
- Pipeline Name: `cp-source-azsqldb-sink-adls-emp-pipeline`
